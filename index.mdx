...
<Box my={25}>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    ...
    <ThinTile to="openapi/banner-academic-catalogs.page.yaml" icon={launchFastIcon} header="Ethos APIs">
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    ...
    <WideTile to="openapi/banner-academic-catalogs.page.yaml" header="Ethos APIs">
